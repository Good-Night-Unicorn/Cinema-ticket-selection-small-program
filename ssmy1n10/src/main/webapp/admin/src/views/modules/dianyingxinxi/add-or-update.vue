    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="影院名称" prop="yingyuanmingcheng">
          <el-select :disabled="ro.yingyuanmingcheng" @change="yingyuanmingchengChange" v-model="ruleForm.yingyuanmingcheng" placeholder="请选择影院名称">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.yingyuanmingcheng" label="影院名称" prop="yingyuanmingcheng">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="播放场次" prop="bofangchangci">
          <el-input v-model="ruleForm.bofangchangci" 
              placeholder="播放场次" clearable  :readonly="ro.bofangchangci"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="播放场次" prop="bofangchangci">
              <el-input v-model="ruleForm.bofangchangci" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="播放时间" prop="bofangshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.bofangshijian" 
                type="datetime"
                placeholder="播放时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.bofangshijian" label="播放时间" prop="bofangshijian">
              <el-input v-model="ruleForm.bofangshijian" 
                placeholder="播放时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	selected : false,
      ...
      rules: {
          ...
          bofangchangci: [
                { required: true, message: '播放场次不能为空', trigger: 'blur' },
          ],
          bofangshijian: [
          ],
          dianyingjianjie: [
  ...
  methods: {
    ...
    // 下二随
    yingyuanmingchengChange () {
      this.$http({
        url: `follow/yingyuanxinxi/yingyuanmingcheng?columnValue=`+ this.ruleForm.yingyuanmingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.yingyuandizhi){
                this.ruleForm.yingyuandizhi = data.data.yingyuandizhi
              }
        } else {
          this.$message.error(data.msg);
        }
	...
	this.ruleForm.dianyingjianjie = this.ruleForm.dianyingjianjie.replace(reg,'../../../ssmy1n10/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
