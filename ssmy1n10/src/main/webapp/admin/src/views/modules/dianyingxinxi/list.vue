  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="影院名称" prop="yingyuanmingcheng">
		  <el-select  @change="yingyuanmingchengChange" clearable v-model="searchForm.yingyuanmingcheng" placeholder="请选择影院名称">
		    <el-option
